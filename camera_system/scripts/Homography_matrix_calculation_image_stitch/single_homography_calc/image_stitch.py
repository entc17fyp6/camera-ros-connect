...
MIN_MATCH_COUNT = 10
narrow_calibration_img = cv.imread('test_camera/narrow_frame.jpg',0)          # queryImage
wide_calibration_img = cv.imread('test_camera/wide_frame.jpg',0) # trainImage

narrow_img_color = cv.cvtColor(cv.imread('test_camera/narrow_frame.jpg'),cv.COLOR_BGR2RGB)          # queryImage
wide_img_color = cv.cvtColor(cv.imread('test_camera/wide_frame.jpg'),cv.COLOR_BGR2RGB) # trainImage
